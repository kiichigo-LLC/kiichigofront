...
import { DESC_DX, pageMeta, titleWithSite } from "@/lib/seo";
import { asset } from "@/lib/wp";

const PATH = "/dx";
const PAGE_TITLE = "DX推進方針について";
...
function DxBody({ pageTitle }: { pageTitle: string }) {
  return (
    <div className="dx elm">
      <div className="dx-inr elm-inr">
        ...
        <div className="dx-main">
          ...
          <div className="dx-main-section">
            <img
              src={asset("img/dx/security_action.svg")}
...
export default function DxPage() {
  return <DxBody pageTitle={PAGE_TITLE} />;
}
