...
export function AboutContent({ pageTitle }: Props) {
  const homeUrl = sitePath("/");
  const contactUrl = sitePath("/contact");
  const dxUrl = sitePath("/dx");
      ...
      <div className="page-inr elm-inr">
            ...
            <table>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <ol>
                      ...
                      <li>
                        各種システム、ソフトウェア等の企画、開発、制作、配信、保守、管理、運営、販売及びそれらの受託
                      </li>
                      <li>楽曲、詞の企画、制作、編集、配信及び販売</li>
                      <li>ナレーション業務</li>
                      <li>
                        動画、その他各種映像の企画、制作、撮影、編集、配信及び販売
                      </li>
                ...
                <tr>
                  ...
                  <td>
                    <Link href={contactUrl}>お問い合わせ</Link>ください。
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <Link href={contactUrl}>お問い合わせフォーム</Link>
                  </td>
                </tr>
                <tr>
                  <th style={{ whiteSpace: "nowrap" }}>URL</th>
                  <td>
                    <a href={homeUrl}>{homeUrl || "https://kiichigo.work/"}</a>
                  </td>
                </tr>
                <tr>
        ...
        <div className="page-main">
          <div className="page-main-img">
            <img
              src={themeAsset("img/logo.svg")}
              alt="モ・ベターデザインの中村健さんが手掛けたキイチゴのロゴ"
            />
          </div>
